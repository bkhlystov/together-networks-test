Feature: Mobile / Common
  ...
  Scenario: Top-bar elements exist
    ...
    Then I wait page element "Top-bar / Mobile Menu Toggle" to be displayed
    Then I expect page element "Top-bar / Customer menu" is displayed
  ...
  Scenario: Spot Pricing
    ...
    Then I wait page element "Spot Pricing / Close button" to not be displayed
    ...
    Then I expect page element "Spot Pricing / View All Charts link" is not displayed
    When I click on page element "Top-bar / Spot Pricing"
  ...
  Scenario: Footer / Map link
    Then I expect page element ".map-link > a[href='https://goo.gl/maps/WrkPLjyC9VsibpAw8'] > img[data-src='/assets/i/footer-map.png']" is displayed
    When I move to element ".map-link > a[href='https://goo.gl/maps/WrkPLjyC9VsibpAw8'] > img[data-src='/assets/i/footer-map.png']"
    Then I wait page element ".map-link > a[href='https://goo.gl/maps/WrkPLjyC9VsibpAw8'] > img[src='/assets/i/footer-map.png']" to be displayed
