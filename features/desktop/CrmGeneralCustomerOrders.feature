Feature: Desctop / Crm / Orders
	...
	Scenario: Orders App
		...
		Then I go to CRM Orders App and check for "General Customer" order number, shipping method "Wire above 7500", order status "Waiting for Approval"
	...
	Scenario: Orders App / Emails Sub-App
		Then I check email "Order Confirmation"
